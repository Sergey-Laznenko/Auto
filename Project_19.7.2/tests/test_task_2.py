...
# Test 1
def test_add_new_pet_without_photo(name=name_ru, animal_type=animal_type_ru, age=age_num):
...
# Test 3
def test_add_new_pet_with_un_normal_name(name=name_long, animal_type=animal_type_ru,
                                         age=age_num, pet_photo='images/cat.jpg'):
...
# Test 4
def test_add_new_pet_with_un_normal_age(name=name_en, animal_type=animal_type_en,
                                        age=age_big, pet_photo='images/cat.jpg'):
...
# Test 5
def test_add_new_pet_with_un_normal_animal_type(name=name_en, animal_type=animal_type_symbols,
                                                age=age_num, pet_photo='images/cat.jpg'):
...
# Test 7
def test_add_new_pet_with_photo_8k(name=name_en, animal_type=animal_type_en,
                                   age=age_num, pet_photo='images/cat_8k.jpg'):
...
# Test 8
def test_add_new_pet_with_space_in_param(name=name_space, animal_type=animal_type_space, age=age_space):
...
# Test 9
def test_change_correct_name_and_type_pet_to_empty_value(name=name_space, animal_type=animal_type_space, age=age_int):
...
# Test 10
def test_add_new_pet_with_str_in_age_instead_int(name=name_ru, animal_type=name_ru,
                                                 age=age_str, pet_photo='images/cat1.jpg'):
